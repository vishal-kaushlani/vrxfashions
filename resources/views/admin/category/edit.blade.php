...
<section class="content">
    ...
    <div class="container-fluid">
        <form action="" method="post" id="category_form" name="category_form" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        @if (!empty($category->image))
                            <div>
                                <img width="250px" height="300px" src="{{ asset('uploads/category/thumb/'.$category->image)}}" alt="">
                            </div>
                        @endif
                        <div class="col-md-6">
                            <div class="mb-3">
